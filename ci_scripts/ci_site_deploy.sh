...
git fetch
git stash push -u  -- $CI_WORKSPACE_PATH/docs $CI_WORKSPACE_PATH/doc_archives
git checkout feature/docc-hosting
rm -rf $CI_WORKSPACE_PATH/docs $CI_WORKSPACE_PATH/doc_archives
git stash apply
git add $CI_WORKSPACE_PATH/docs $CI_WORKSPACE_PATH/doc_archives
