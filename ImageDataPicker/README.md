...
- `main` runs the production schemes for verification.
- `vX.Y.Z` tags created from `main` publish the production XCFramework release and the Swift Package Manager release version.
